              ...
              <div className={classes.adminForm2l}>
                <div className={classes.adminForm3}>
                  ...
                  <input
                    ...
                    value={value.test}
                    onChange={(e) => {
                      const newValue = e.target.value.replace(/[^a-z A-Z]/g, ''); // Allow only alphabet characters
                      setValue({ ...value, test: newValue });
                    }}
                  />
                </div>
                <div className={classes.adminForm3}>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      // Check if the input is valid: contains only numbers and ends with 'P' or 'T'
                      if (/^\d*(P|T)?$/.test(newValue)) {
                        setValue({ ...value, subjectCode: newValue });
                      }
                    }}
                  />
                </div>
